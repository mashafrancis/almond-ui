...
# Admin panel demo
---
A full-sized sample Admin panel can be seen [here](https://dashboard.almond-ui.dev/).
...
```tsx
import { Sidebar, useSidebar } from '@almond-ui/core';
```
...
<View>
  <Sidebar>
    <Sidebar.Head>
      <Sidebar.Head.Logo>
        <Image src="/images/almond.svg" width={48} height={48} alt="Rewind-UI" />
      </Sidebar.Head.Logo>
...
```tsx
import { useSidebar, Sidebar, Button } from '@almond-ui/core';
